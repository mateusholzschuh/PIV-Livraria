    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (String.valueOf(acao)) {
            case "mostrar":
                ...
                if(obj.getAvaliacaos().isEmpty())
                    estrelas = 0;
                else
                {
                    int sum = 0;
                    for (Avaliacao a : obj.getAvaliacaos()) {
                        sum += a.getEstrelas();
                    }
                    sum /= obj.getAvaliacaos().size();
                    estrelas = sum;
                }
