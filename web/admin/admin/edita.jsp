        ...
        <form action="UploadWS" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-5 pr-md-1">
                    <div class="form-group">
                        <label>Senha</label>
                        <input type="password" name="txtSenha" required class="form-control" value="">
                    </div>
                </div>
                <div class="col-md-7">
                    <div class="form-group-file">
                        <label for="file">Foto</label>
                        <input type="file" id="file" name="txtFoto" required class="form-control form-control-file" value="./../../arquivos/${obj.foto}">
                    </div>
                </div>
            </div>
